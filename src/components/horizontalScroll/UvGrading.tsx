...
export default function UvGrading({ uvObject }: uvGradingInterface) {
  ...
  const rotateClass = `rotate-[${degrees}deg]`;
  return (
    <div className="flex gap-2">
      ...
      <div className="h-10 w-10 rounded-full bg-gradient-to-r from-green-500 via-yellow-500 to-red-500 relative -mb-4 flex justify-center items-center">
        <div className={`h-8 w-[8px] relative z-10 ${rotateClass} -mt-1`}>
          <div className="w-0 h-0 border-l-[4px] border-l-transparent border-b-[16px] border-b-sky-600 border-r-[4px] border-r-transparent"></div>
        </div>
