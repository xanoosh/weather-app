...
export default function HourForecastElement({
  ...
  return (
    <HourForecastDialog hourForecast={hourForecast} weatherName={weatherName}>
      <button className="py-3 px-4 bg-white/30 flex flex-col gap-2 justify-center items-center text-white rounded min-w-28 focus:outline-none focus:border-2 focus:border-white">
