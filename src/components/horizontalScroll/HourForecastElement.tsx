...
export default function HourForecastElement({
  ...
  return (
    <div className="pt-7 relative text-white">
      ...
      >
        <button
          className={`py-2 px-4 flex flex-col gap-2 justify-center items-center rounded min-w-28 border-2 border-transparent focus:outline-none focus:bg-white/20 relative ${afterElementStyle}`}
        >
