...
export default function HourForecastElement({
  ...
  return (
    ...
    >
      <button
        className={`py-2 px-4 mt-6 flex flex-col gap-2 justify-center items-center text-white rounded min-w-28 border-2 border-transparent focus:outline-none focus:bg-white/20 relative ${afterElementStyle}`}
      >
        <div className="absolute flex gap-2 -top-7 left-1 w-full">
